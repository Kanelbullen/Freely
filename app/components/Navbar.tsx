...
const Navbar: React.FC = () => {
    ...
    return (
        <nav className="bg-gray-800 p-4 fixed w-full z-50 top-0 shadow-lg">
            <div className="container mx-auto flex items-center justify-between">
                <div className="text-white text-2xl font-bold">
                    <Link href="/">StreamSite</Link>
                </div>
            ...
            {isOpen && (
                <div className="md:hidden">
                    ...
                    {session ? (
                        ...
                        <button onClick={() => signIn()} className="block w-full text-left px-4 py-2 text-gray-300 hover:text-white">Sign In</button>
                    )}
                </div>
            )}
        </nav>
